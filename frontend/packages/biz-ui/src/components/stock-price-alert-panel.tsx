...
import { fetchAPI, isAuthenticated, stocksApi, type NotifyChannel } from '@panwatch/api'
...
export default function StockPriceAlertPanel(props: {
  ...
  const loadSummaryOnly = useCallback(async () => {
    // 价格提醒是站长个人功能(/price-alerts 受登录保护),匿名访客不预载,避免 401
  ...
  // 匿名公开版:价格提醒是仅站长功能,访客不显示该入口(也就没有对应的受保护请求)
